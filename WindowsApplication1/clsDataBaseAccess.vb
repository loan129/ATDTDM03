...
Public Class DataBaseAccess
    ...
    Private connectionstring As String = "workstation id=chuongtrinhVB.mssql.somee.com;packet size=4096;user id=hoangtvps03510_SQLLogin_1;pwd=h6jsb38u9d;data source=chuongtrinhVB.mssql.somee.com;persist security info=False;initial catalog=chuongtrinhVB"
